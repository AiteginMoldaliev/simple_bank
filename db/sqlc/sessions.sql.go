...
const creatSessions = `-- name: CreatSessions :one
...
type CreatSessionsParams struct {
...
func (q *Queries) CreatSessions(ctx context.Context, arg CreatSessionsParams) (Session, error) {
	row := q.db.QueryRowContext(ctx, creatSessions,
		arg.ID,
		arg.Username,
		arg.RefreshToken,
		arg.UserAgent,
